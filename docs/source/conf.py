# -*- coding: utf-8 -*-
#
# ipyvolume documentation build configuration file, created by
...
project = u'ipyvolume'
copyright = u'2017, Maarten A. Breddels'
author = u'Maarten A. Breddels'
...
htmlhelp_basename = 'ipyvolumedoc'
...
latex_documents = [
    (master_doc, 'ipyvolume.tex', u'ipyvolume Documentation',
...
man_pages = [
    (master_doc, 'ipyvolume', u'ipyvolume Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ipyvolume', u'ipyvolume Documentation',
     author, 'ipyvolume', 'One line description of project.',
     'Miscellaneous'),
]
